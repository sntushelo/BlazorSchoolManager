...
namespace BlazorSchoolManager.Shared.Constants.Permission
{
    public static class Permissions
    {
        public static class Attendance
        {
            ...
            public const string Export = "Permissions.Attendance.Export";
            public const string Search = "Permissions.Attendance.Search";
        }
        ...
        public static class Lessons 
        {
            ...
            public const string Export = "Permissions.Lessons.Export";
            public const string Search = "Permissions.Lessons.Search";
        }
