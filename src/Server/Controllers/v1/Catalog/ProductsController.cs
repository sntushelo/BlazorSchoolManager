...
using BlazorSchoolManager.Application.Features.Products.Commands.Delete;
using BlazorSchoolManager.Application.Features.Products.Queries.Export;
using BlazorSchoolManager.Application.Features.Products.Queries.GetAllPaged;
using BlazorSchoolManager.Application.Features.Products.Queries.GetProductImage;
using BlazorSchoolManager.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace BlazorSchoolManager.Server.Controllers.v1.Catalog
{
