...
using BlazorSchoolManager.Application.Features.ExtendedAttributes.Commands.AddEdit;
using BlazorSchoolManager.Application.Features.ExtendedAttributes.Commands.Delete;
using BlazorSchoolManager.Application.Features.ExtendedAttributes.Queries.Export;
using BlazorSchoolManager.Application.Features.ExtendedAttributes.Queries.GetAll;
using BlazorSchoolManager.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using BlazorSchoolManager.Application.Features.ExtendedAttributes.Queries.GetById;
using BlazorSchoolManager.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace BlazorSchoolManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
