...
using BlazorSchoolManager.Application.Features.DocumentTypes.Commands.Delete;
using BlazorSchoolManager.Application.Features.DocumentTypes.Queries.Export;
...
namespace BlazorSchoolManager.Server.Controllers.Utilities.Misc
{
