...
{
    public partial class AddEditVenueModal
    {
        [Inject] private IVenueManager VenueManager { get; set; }

        [Parameter] public AddEditVenueCommand AddEditVenueModel { get; set; } = new();
        ...
        {
            var response = await VenueManager.SaveAsync(AddEditVenueModel);
