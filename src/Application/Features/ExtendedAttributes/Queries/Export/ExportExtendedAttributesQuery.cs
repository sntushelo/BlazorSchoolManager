...
using BlazorSchoolManager.Application.Specifications.ExtendedAttribute;
...
namespace BlazorSchoolManager.Application.Features.ExtendedAttributes.Queries.Export
{
